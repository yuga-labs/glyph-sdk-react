...
const Toaster = ({ ...props }: ToasterProps) => {
    return (
        <Sonner
            ...
            toastOptions={{
                classNames: {
                    toast: "gw-toast group-[.gw-toaster]:gw-bg-background group-[.gw-toaster]:gw-text-foreground group-[.gw-toaster]:gw-border-border gw-rounded-2xl group-[.gw-toaster]:gw-shadow-lg !gw-w-[20rem]",
